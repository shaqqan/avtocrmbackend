...
import {
  FeedbacksThemeMultiLanguageResponseDto,
  FeedbacksThemeResponseDto,
} from '../dto/response/feedbacks-theme.res.dto';
...
export class FeedbacksThemeMapper {
  ...
  static toEntityFromUpdateDto(
    dto: UpdateFeedbacksThemeDto,
    existingTheme: FeedbacksTheme,
  ): FeedbacksTheme {

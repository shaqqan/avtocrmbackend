...
export class CreateBookDto {
  @ApiProperty({
    description: 'Book name in Russian',
    example: 'Война и мир',
    maxLength: 100,
  })
  @IsString()
  ...
  @ApiProperty({
    description: 'Book name in Uzbek',
    example: 'Urush va tinchlik',
    maxLength: 100,
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    description: 'Book description in Uzbek',
    example: 'Bu kitob Tolstoyning eng mashhur asari...',
    maxLength: 1500,
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    description: 'Book description in Russian',
    example: 'Эта книга является самым известным произведением Толстого...',
    maxLength: 1500,
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    ...
    example: "This book is Tolstoy's most famous work...",
    maxLength: 1500,
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    ...
    example: 'storage/covers/war-and-peace.jpg',
    maxLength: 255,
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    description: 'File IDs (PDFs, EPUBs, etc.)',
    example: [1, 2],
    type: [Number],
    required: false,
  })

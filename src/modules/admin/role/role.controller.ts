...
export class RoleController {
  ...
  create(@Body() createRoleDto: CreateRoleDto): Promise<MessageWithDataResponseDto> {
  ...
  update(@Param('id', ParseIntPipe) id: number, @Body() updateRoleDto: UpdateRoleDto): Promise<MessageWithDataResponseDto> {

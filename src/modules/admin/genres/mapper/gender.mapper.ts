...
import { GenreResponseDto, GenreResponseMultiLangDto } from "../dto/response/genre.res.dto";
...
export class GenreMapper {
    ...
    static toDtoList(entities: Genre[]): GenreResponseDto[] {
        ...
        return entities.map(entity => new GenreResponseDto(
            entity.id,
            entity.parentId,
            entity.cover,
            entity[`name_${locale}`],
            ...
            entity.createdAt,
            entity.updatedAt,
            entity.children?.map(child => new GenreResponseDto(
                child.id,
                child.parentId,
                child.cover,
                child[`name_${locale}`],
    ...
    static toEntityFromUpdateDto(dto: UpdateGenreDto, existingGenre: Genre): Genre {

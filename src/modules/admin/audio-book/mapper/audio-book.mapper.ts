import {
  AudioBookResponseDto,
  AudioBookResponseMultiLangDto,
} from '../dto/response/audio-book.res.dto';
...
export class AudioBookMapper {
  ...
  static toEntityFromCreateDto(dto: CreateAudioBookDto): AudioBook {
    ...
    const { authorsIds, genresIds, issuersIds, filesIds, ...audioBookData } =
      dto;

...
export class CreateAudioBookDto {
  @ApiProperty({
    description: 'AudioBook name in Russian',
    example: 'Война и мир (аудиокнига)',
    maxLength: 100,
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    description: 'AudioBook name in Uzbek',
    example: 'Urush va tinchlik (audiokitob)',
    maxLength: 100,
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    description: 'AudioBook name in English',
    example: 'War and Peace (audiobook)',
    maxLength: 100,
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    description: 'AudioBook description in Uzbek',
    example: 'Bu audiokitob Tolstoyning eng mashhur asari...',
    maxLength: 1500,
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    description: 'AudioBook description in Russian',
    example:
      'Эта аудиокнига является самым известным произведением Толстого...',
    maxLength: 1500,
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    description: 'AudioBook description in English',
    example: "This audiobook is Tolstoy's most famous work...",
    maxLength: 1500,
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    ...
    example: 'storage/covers/war-and-peace-audio.jpg',
    maxLength: 70,
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Issuer/Publisher IDs',
    example: [1],
    type: [Number],
  })
  @IsArray()
  ...
  @ApiProperty({
    description: 'File IDs (Audio files, PDFs, etc.)',
    example: [1, 2],
    type: [Number],
    required: false,
  })

...
export const JwtConfig = registerAs('jwt', () => ({
    admin: {
        ...
        accessTokenTtl: parseInt(process.env.JWT_ADMIN_ACCESS_TOKEN_TTL, 10),
        refreshTokenTtl: parseInt(process.env.JWT_ADMIN_REFRESH_TOKEN_TTL, 10),
    },
    core: {
        ...
        accessTokenTtl: parseInt(process.env.JWT_CORE_ACCESS_TOKEN_TTL, 10),
        refreshTokenTtl: parseInt(process.env.JWT_CORE_REFRESH_TOKEN_TTL, 10),
    }
})); 
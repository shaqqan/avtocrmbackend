  ...
  async seed() {
    ...
    const permissionsData: PermissionData[] = [
      ...
      },
      {
        ...
        name: {
          ...
          uz: 'Ruxsatni tahrirlash',
          ru: 'Обновить разрешение',
        },
      },
      {
      ...
      },
      {
        ...
        name: {
          en: 'Publish Book',
          uz: 'Kitobni nashr etish',
          ru: 'Опубликовать книгу',
        },
      },
      ...
      // AudioBook Management Permissions
      {
        ...
        name: {
          en: 'Create AudioBook',
          uz: 'Audio kitob yaratish',
          ru: 'Создать аудиокнигу',
        },
      },
      {
        ...
        name: {
          en: 'Read AudioBook',
          uz: "Audio kitobni ko'rish",
          ru: 'Просмотр аудиокниги',
        },
      },
      {
        ...
        name: {
          en: 'Update AudioBook',
          uz: 'Audio kitobni tahrirlash',
          ru: 'Обновить аудиокнигу',
        },
      },
      {
        ...
        name: {
          en: 'Delete AudioBook',
          uz: "Audio kitobni o'chirish",
          ru: 'Удалить аудиокнигу',
        },
      },
      {
        action: PermissionsEnum.PUBLISH_AUDIOBOOK,
        name: {
          en: 'Publish AudioBook',
          uz: 'Audio kitobni nashr etish',
          ru: 'Опубликовать аудиокнигу',
        },
      },
      ...
      // Publisher/Issuer Management Permissions
      {
        ...
        name: {
          en: 'Create Publisher',
          uz: 'Nashriyot yaratish',
          ru: 'Создать издательство',
        },
      },
      {
        ...
        name: {
          en: 'Read Publisher',
          uz: "Nashriyotni ko'rish",
          ru: 'Просмотр издательства',
        },
      },
      {
        ...
        name: {
          en: 'Update Publisher',
          uz: 'Nashriyotni tahrirlash',
          ru: 'Обновить издательство',
        },
      },
      {
        ...
        name: {
          en: 'Delete Publisher',
          uz: "Nashriyotni o'chirish",
          ru: 'Удалить издательство',
        },
      },
      ...
      },
      {
        ...
        name: {
          en: 'Publish News',
          uz: 'Yangilikni nashr etish',
          ru: 'Опубликовать новость',
        },
      },
      ...
      // Feedback Theme Management Permissions
      {
        ...
        name: {
          en: 'Create Feedback Theme',
          uz: 'Fikr-mulohaza mavzusi yaratish',
          ru: 'Создать тему отзыва',
        },
      },
      {
        action: PermissionsEnum.READ_FEEDBACK_THEME,
        name: {
          en: 'Read Feedback Theme',
          uz: "Fikr-mulohaza mavzusini ko'rish",
          ru: 'Просмотр темы отзыва',
        },
      },
      {
        action: PermissionsEnum.UPDATE_FEEDBACK_THEME,
        name: {
          en: 'Update Feedback Theme',
          uz: 'Fikr-mulohaza mavzusini tahrirlash',
          ru: 'Обновить тему отзыва',
        },
      },
      {
        action: PermissionsEnum.DELETE_FEEDBACK_THEME,
        name: {
          en: 'Delete Feedback Theme',
          uz: "Fikr-mulohaza mavzusini o'chirish",
          ru: 'Удалить тему отзыва',
        },
      },
      ...
      // Book-Audiobook Link Management Permissions
      {
        ...
        name: {
          en: 'Create Book-Audiobook Link',
          uz: "Kitob-Audio kitob bog'lanishini yaratish",
          ru: 'Создать связь книга-аудиокнига',
        },
      },
      {
        action: PermissionsEnum.READ_BOOK_AUDIOBOOK_LINK,
        name: {
          en: 'Read Book-Audiobook Link',
          uz: "Kitob-Audio kitob bog'lanishini ko'rish",
          ru: 'Просмотр связи книга-аудиокнига',
        },
      },
      {
        action: PermissionsEnum.UPDATE_BOOK_AUDIOBOOK_LINK,
        name: {
          en: 'Update Book-Audiobook Link',
          uz: "Kitob-Audio kitob bog'lanishini tahrirlash",
          ru: 'Обновить связь книга-аудиокнига',
        },
      },
      {
        action: PermissionsEnum.DELETE_BOOK_AUDIOBOOK_LINK,
        name: {
          en: 'Delete Book-Audiobook Link',
          uz: "Kitob-Audio kitob bog'lanishini o'chirish",
          ru: 'Удалить связь книга-аудиокнига',
        },
      },
      ...
      // Review Management Permissions
      {
        ...
        name: {
          en: 'Create Book Review',
          uz: 'Kitob sharhini yaratish',
          ru: 'Создать рецензию книги',
        },
      },
      {
        ...
        name: {
          en: 'Read Book Review',
          uz: "Kitob sharhini ko'rish",
          ru: 'Просмотр рецензии книги',
        },
      },
      {
        action: PermissionsEnum.UPDATE_BOOK_REVIEW,
        name: {
          en: 'Update Book Review',
          uz: 'Kitob sharhini tahrirlash',
          ru: 'Обновить рецензию книги',
        },
      },
      {
        action: PermissionsEnum.DELETE_BOOK_REVIEW,
        name: {
          en: 'Delete Book Review',
          uz: "Kitob sharhini o'chirish",
          ru: 'Удалить рецензию книги',
        },
      },
      {
        action: PermissionsEnum.MODERATE_BOOK_REVIEW,
        name: {
          en: 'Moderate Book Review',
          uz: 'Kitob sharhini moderatsiya qilish',
          ru: 'Модерировать рецензию книги',
        },
      },

      {
        ...
        name: {
          en: 'Create Audiobook Review',
          uz: 'Audio kitob sharhini yaratish',
          ru: 'Создать рецензию аудиокниги',
        },
      },
      {
        action: PermissionsEnum.READ_AUDIOBOOK_REVIEW,
        name: {
          en: 'Read Audiobook Review',
          uz: "Audio kitob sharhini ko'rish",
          ru: 'Просмотр рецензии аудиокниги',
        },
      },
      {
        action: PermissionsEnum.UPDATE_AUDIOBOOK_REVIEW,
        name: {
          en: 'Update Audiobook Review',
          uz: 'Audio kitob sharhini tahrirlash',
          ru: 'Обновить рецензию аудиокниги',
        },
      },
      {
        action: PermissionsEnum.DELETE_AUDIOBOOK_REVIEW,
        name: {
          en: 'Delete Audiobook Review',
          uz: "Audio kitob sharhini o'chirish",
          ru: 'Удалить рецензию аудиокниги',
        },
      },
      {
        action: PermissionsEnum.MODERATE_AUDIOBOOK_REVIEW,
        name: {
          en: 'Moderate Audiobook Review',
          uz: 'Audio kitob sharhini moderatsiya qilish',
          ru: 'Модерировать рецензию аудиокниги',
        },
      },
      ...
      },
      {
        ...
        name: {
          en: 'Backup System',
          uz: 'Tizimni zaxiralash',
          ru: 'Резервное копирование системы',
        },
      },
      {
      ...
      },
      {
        ...
        name: {
          en: 'Approve Content',
          uz: 'Kontentni tasdiqlash',
          ru: 'Утвердить контент',
        },
      },
      {
        ...
        name: {
          en: 'Reject Content',
          uz: 'Kontentni rad etish',
          ru: 'Отклонить контент',
        },
      },
    ...
    for (const permissionData of permissionsData) {
      try {
        ...
        console.error(
          `❌ Error seeding permission ${permissionData.action}:`,
          error.message,
        );
        skippedCount++;
      }
    ...
    console.log(
      `   📊 Total: ${createdCount + updatedCount} permissions processed`,
    );
  }
}

...
export class Book extends BaseEntity {
  ...
  @Column({
    type: 'enum',
    enum: PublishedEnum,
    default: PublishedEnum.UNPUBLISHED,
  })
  ...
  getAvgRating(): number {
    ...
    return (
      this.reviews.reduce((acc, review) => acc + Number(review.rating), 0) /
      this.reviews.length
    );
  }
  ...
  decodeName() {
    ...
    this.description_en = this.description_en
      ...
      : this.description_en;
    this.description_short_uz = this.description_short_uz
      ? decodeHTML(this.description_short_uz)
      : this.description_short_uz;
    this.description_short_ru = this.description_short_ru
      ? decodeHTML(this.description_short_ru)
      : this.description_short_ru;
    this.description_short_en = this.description_short_en
      ? decodeHTML(this.description_short_en)
